...
def process_data(data):
    ...
    for item in tqdm(data,desc="process data"):
        inputs.append(create_few_shot(item['user_query'], item['query_absa'], item['knowledge_sentence'], item['knowledge_absa']))
...
train_data = load_data("/home/zhuangjt/zhuangjt_disk3/SK-TOD/InstructKS/Dynamic_InstructKS_Dataset/train_dataset_absa_2.json")
val_data = load_data("/home/zhuangjt/zhuangjt_disk3/SK-TOD/InstructKS/Dynamic_InstructKS_Dataset/val_dataset_absa_2.json")
...
training_args = Seq2SeqTrainingArguments(
    ...
    do_train=True,
    do_eval=True,
    output_dir='./results/QuaSiKS_reviewer_2neg2pos_absa',

...
if negative_sample_size != 0:
    save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/QuaSiKS_reviewer_{positive_sample_size}pos{negative_sample_size}neg_withoutabsa.json"
else:
    save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/QuaSiKS_reviewer_{positive_sample_size}pos_withoutabsa.json"

...
# 加载 tokenizer 和模型
tokenizer = AutoTokenizer.from_pretrained('./results/Instruct-flan-2pos2neg/checkpoint-35035')  # 指向保存 tokenizer 的目录
model = AutoModelForSeq2SeqLM.from_pretrained('./results/Instruct-flan-2pos2neg/checkpoint-35035')  # 指向保存模型的目录
model.to(device)
...
save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/RandomInstructKS.json"

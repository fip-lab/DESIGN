...
parser.add_argument('--positive_sample_size', type=int, default=5, help='Number of positive samples')
parser.add_argument('--negative_sample_size', type=int, default=0, help='Number of negative samples')
...
training_args = Seq2SeqTrainingArguments(
    ...
    do_train=True,
    do_eval=True,
    output_dir=f'./results/QuaSiKS_entity_{negative_sample_size}neg{positive_sample_size}pos_withoutabsa',

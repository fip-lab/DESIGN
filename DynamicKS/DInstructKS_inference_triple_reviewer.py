...
output:""".format(user_query,aspect_item_of_query,knowledge_sentence)
    ...
    print(score)
    print(triple)
    print(resourse_triples_new[I[0][0]])
    '''
    ##索引是I[0][0]
...
save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/{alignment_type}_reviewer_{positive_sample_size}pos{negative_sample_size}neg.json"

...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "1,0"  # 如果你的两张卡的编号是0和1
...
tokenizer = AutoTokenizer.from_pretrained('/home/zhuangjt/zhuangjt_disk3/SK-TOD/PLM/tk-instruct-large-def-pos')
...
# 5. 训练模型
model = AutoModelForSeq2SeqLM.from_pretrained('/home/zhuangjt/zhuangjt_disk3/SK-TOD/PLM/tk-instruct-large-def-pos')
...
training_args = Seq2SeqTrainingArguments(
    ...
    do_train=True,
    do_eval=True,
    output_dir='./results/DInstructKS-tklarge-2POS2NEG-3',

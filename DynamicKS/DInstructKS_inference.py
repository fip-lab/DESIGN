...
if negative_sample_size != 0:
    save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/QuaSiKS_{positive_sample_size}pos{negative_sample_size}neg_entity.json"
else:
    save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/QuaSiKS_{positive_sample_size}pos_entity.json"

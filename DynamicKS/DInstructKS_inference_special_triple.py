...
dataset_split = "test"
alignment_type = "triple"
sample_size = 2

# 加载 tokenizer 和模型
tokenizer = AutoTokenizer.from_pretrained('/home/zhuangjt/zhuangjt_disk3/SK-TOD/results/DEALinKS_reviewer_2neg2pos/checkpoint-78700')  # 指向保存 tokenizer 的目录
model = AutoModelForSeq2SeqLM.from_pretrained('/home/zhuangjt/zhuangjt_disk3/SK-TOD/results/DEALinKS_reviewer_2neg2pos/checkpoint-78700')  # 指向保存模型的目录
model.to(device)
...
save_path = f"/home/zhuangjt/zhuangjt_disk3/SK-TOD/pred/{dataset_split}/DEALinKS_2pos2neg_reviewer_with_metadata.json"

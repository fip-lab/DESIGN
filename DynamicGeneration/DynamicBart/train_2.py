...
if args.withabsa and args.select_algorithm == 'RANDOM':
    output_path = f"./results/{args.model_name}-{args.top_k_shot}-shot-Random-earlystop-absa-9e-5"
elif args.withabsa and args.select_algorithm == 'SELECT':
    output_path = f"./results/{args.model_name}-{args.top_k_shot}-shot-earlystop-absa-9e-5"
elif not args.withabsa and args.select_algorithm == 'RANDOM':
    output_path = f"./results/{args.model_name}-{args.top_k_shot}-shot-withoutabsa-Random-earlystop-9e-5"
elif not args.withabsa and args.select_algorithm == 'SELECT':
    output_path = f"./results/{args.model_name}-{args.top_k_shot}-shot-withoutabsa-earlystop-9e-5"
print('----------')
print(output_path)
print('----------')
training_args = Seq2SeqTrainingArguments(
    ...
    learning_rate=9e-5,                     # 学习率    learning_rate=3e-5,                     # 学习率
